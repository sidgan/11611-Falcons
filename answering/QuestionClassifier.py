...
class QuestionClassifier:
    ...
    def __init__(self, use_pickle=False):  # Set use_pickle = False to re-train models
    ...
    def train(self, training_set):
        ...
        if not self.USE_PICKLE:
            ...
            logger.debug('Training: Fitted model')
            ...
            logger.debug('Training: Model and dictionary was saved successfully')
